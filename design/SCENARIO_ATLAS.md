...
After direction selection, make a six-frame storyboard for the chosen mission: arrival, readable situation, optional investigation, dialogue/commitment, peaceful or tactical resolution, and remembered return. Pair each frame with its precise action/state change and the reusable props/animation needs. Then test that thin encounter on Pixel 10 Pro and iPad M2 before widening production. Do not commission every mission's assets before this packet proves the process.
