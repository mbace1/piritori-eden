...
`kallio-kit-v02.glb` is the current art candidate: 15 Blender motifs, 41,800
triangles, 3,586,560 bytes, with cavity vertex colours. It reuses the v01 painted
textures. `kallio-kit-v02.manifest.json` pins its bytes/hashes. See
`design/C16_ART_FINISH.md` and the generator under `tools/blender/`. Version 01
is retained for rollback. Neither file name certifies final art approval.
